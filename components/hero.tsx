...
export function Hero() {
  ...
  return (
    <section id="home" className="relative w-full h-screen flex items-center justify-center overflow-hidden">
      {/* Heavily Zoomed Background Image */}
      <div className="absolute inset-0 z-0">
        <Image
          ...
          fill
          priority
          className="object-cover object-center scale-[2] sm:scale-[2.2] md:scale-[2.4] lg:scale-[2.6] xl:scale-[2.8] transition-transform duration-500"
        />
      ...
      <div className="absolute inset-0 z-5 pointer-events-none">
        ...
        <div className="absolute top-1/4 left-8 w-2 h-32 bg-gradient-to-b from-green-400 to-transparent rotate-12" />
        <div className="absolute bottom-1/4 right-12 w-2 h-24 bg-gradient-to-t from-yellow-400 to-transparent -rotate-12" />
        <div className="absolute top-1/2 left-1/4 w-px h-16 bg-white/30 rotate-45" />
      </div>
