    ...
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white max-w-6xl mx-auto px-4">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-black mb-8 leading-none">
          ...
          <span className="block text-4xl md:text-5xl lg:text-6xl font-light tracking-widest text-green-300 mt-2">
            EDWARDS
          </span>
        </h1>
        ...
        <div className="relative mb-8">
          ...
          <p className="text-xl md:text-2xl font-light tracking-wide bg-black/50 px-8 py-2 rounded-full inline-block">
            NATURE • PHOTOGRAPHY • STORYTELLER
          </p>
        </div>

        <p className="text-lg md:text-xl mb-12 max-w-3xl mx-auto leading-relaxed font-light">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
          <Button
            ...
            size="lg"
            className="bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-lg px-8 py-4 rounded-full shadow-2xl transform hover:scale-105 transition-all duration-300"
          >
            EXPLORE PORTFOLIO
          </Button>
          <Button
            ...
            size="lg"
            variant="outline"
            className="border-2 border-white text-black hover:bg-white hover:text-stone-900 text-lg px-8 py-4 rounded-full backdrop-blur-sm transform hover:scale-105 transition-all duration-300"
          >
            GET IN TOUCH
          </Button>
        </div>
